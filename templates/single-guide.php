    ...
    <div class="tk-single__hero tk-single__hero--guide" style="background-color:#0d1117">
        ...
        <div class="tk-single__hero-content tk-single__hero-content--guide">
            <div class="tk-single__breadcrumb">
                <a href="<?php echo esc_url( get_post_type_archive_link('tk_guide') ) ?>"><?php _e('Guides','trailkit') ?></a>
                <span>›</span>
            ...
            <div class="tk-guide-header">
                ...
                <div class="tk-guide-header__info">
                    ...
                    <?php if ( $guide['price_from'] ): ?>
                        <p class="tk-guide-header__price"><?php printf(__('From $%s / day','trailkit'), esc_html(number_format($guide['price_from']))) ?></p>
                    <?php endif; ?>
    ...
    <div class="tk-single__body">
        ...
        <div class="tk-single__guide-layout">
            ...
            <div class="tk-single__guide-main">
                <h2 class="tk-single__section-title"><?php _e('About','trailkit') ?></h2>
                ...
                <div class="tk-single__section" style="margin-top:2rem">
                    <h2 class="tk-single__section-title"><?php _e('Service Area','trailkit') ?></h2>
            ...
            <aside class="tk-single__guide-sidebar">
                <div class="tk-contact-card">
                    <h3 class="tk-contact-card__title"><?php _e('Contact','trailkit') ?></h3>
                    ...
                    <div class="tk-contact-card__price">
                        <span class="tk-contact-card__price-label"><?php _e('Starting from','trailkit') ?></span>
                        <span class="tk-contact-card__price-value">$<?php echo esc_html(number_format($guide['price_from'])) ?> <small><?php _e('/day','trailkit') ?></small></span>
                    </div>
                    <?php endif; ?>
                </div>
            </aside>
