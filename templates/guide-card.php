    ...
    <div class="tk-card__guide-header">
        <div class="tk-card__avatar">
            ...
            <?php if ( $guide['is_featured'] ): ?>
                <span class="tk-card__featured-badge" title="<?php _e('Featured','trailkit') ?>">★</span>
            <?php endif; ?>
        </div>
        <div class="tk-card__guide-info">
            <h3 class="tk-card__title"><?php echo esc_html($title) ?></h3>
            <?php if ( $guide['price_from'] ): ?>
                <span class="tk-card__price"><?php printf( __('From $%s/day','trailkit'), esc_html(number_format($guide['price_from'])) ) ?></span>
            <?php endif; ?>
